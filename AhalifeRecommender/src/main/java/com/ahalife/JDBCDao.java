...
public class JDBCDao {
  ...
  private static String GET_PRODUCTS_CATEGORIES =
      "select bcpr.CATEGORY_ID,bcpr.PRODUCT_ID from blc_product bp join blc_category_product_xref bcpr using (PRODUCT_ID) where bp.PRODUCT_ID in (:ids)";
  ...
  private static DataSource getDataSource() {
    if (dataSource == null) {
      ...
      dataSource.setUrl("jdbc:mysql://localhost:3306/broadleaf?autoReconnect=true");
